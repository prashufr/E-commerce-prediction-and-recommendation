...
if selected_page == "DataFrame":
    ...
    path = "/Users/prasanth/Desktop/ds_projects/Ecom/classification_data.csv"
    df = pd.read_csv(path)
    st.dataframe(df)
...
df1 = pd.read_csv('/Users/prasanth/Desktop/ds_projects/Ecom/df1 copy.csv')  
...
model = load_model('/Users/prasanth/Desktop/ds_projects/Ecom/random_forest_model.pkl')
...
if selected_page == "Recommendations":
    ...
    movies_data = pd.DataFrame.from_dict(pickle.load(open('/Users/prasanth/Desktop/ds_projects/Ecom/movies.pkl', 'rb')))
    similarity_data = pickle.load(open('/Users/prasanth/Desktop/ds_projects/Ecom/similarity.pkl', 'rb'))
